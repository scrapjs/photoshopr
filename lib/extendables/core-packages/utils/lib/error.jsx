...
exports.ArithmeticError = Error.factory("ArithmeticError");
...
exports.ImportError = Error.factory("ImportError");
...
exports.EnvironmentError = Error.factory("EnvironmentError");
...
exports.ParseError = Error.factory("ParseError");
...
exports.SystemError = Error.factory("SystemError");
...
var is_indesign = string.contains(string.to(app.name, 'lower'), 'indesign');
if (is_indesign) {
	/**
	 * @class
